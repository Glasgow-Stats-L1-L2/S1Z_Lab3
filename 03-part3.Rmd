...
Create a plot to display the relationship between `runs` and `homeruns`, i.e. with `runs` as your outcome/response variable and `homeruns` as your explanatory/predictor variable. Add a title and axes labels using the same method as before. 
